...
const signUp = () => {
  ...
  .then(response => {
    ...
    setErrorMessage("Company registered successfully! Please check your email to verify your account.")
  })
  .catch(error => {
...
<div>
                 ...
                 {errorMessage && errorMessage != "Your Request will be validated by an admin as soon as possible !Please check your email "?<div class="p-4 mb-4 flex justify-center relative text-sm text-red-800 rounded-lg bg-red-200 mt-5  dark:text-red-400" role="alert">
