          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  onClick={() => logout()}
                  className="text-gray-700  hover:text-sm rounded hover:bg-red-200 hover:text-black  transition duration-200 ease-in-out px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                >
                  Logout
                </a>
              </li>
