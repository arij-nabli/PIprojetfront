...
const NotificationDropdown = (props) => {
  ...
  const getNotifications = async () => {
    const response = await axios.get(`https://esprit-compass-backend.vercel.app/notifications/student/${props.userId}`);
  ...
  const getHardSkills = async()=>{
    const response = await axios.get(`https://esprit-compass-backend.vercel.app/user/getUserHardSkills/${props.userId}`).then((response) => {
  ...
  const saveNotification = async (notification) => {
    await axios.post('https://esprit-compass-backend.vercel.app/notifications', notification);
  ...
  const clickNotification = async (notification) => {
    ...
    await axios.put(`https://esprit-compass-backend.vercel.app/notifications/${id}`);
    console.log(props);
