...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="md:left-0 my-8 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-gray-100 flex flex-wrap items-center mr-10 justify-between relative md:w-64 z-10 py-4 px-6">
